...
####분자 운동
현대 철학은 여러 학문적 개념을 흡수해서 통합적으로 나아간다?->말같지도 않은 소리
molcule - 최소단위의 입자
분자와 대립 개념 : 몰(mole) 동질의 입자가 하나의 집계로서 존재하는 단위
전체화되고 구조화된 것을 [몰적인 것]으로 개념화
이렇나 유기체적 질서를 가로지르며 탈주하는 힘들을 [분자적인 것]이라 함

### 2. 주름(형식)과 기억(내용)
주름은 신체의 주름으로 내면회되기도 하고 문체의 주름으로 표면화되기도 함.
신체의 주름은 세계와 몸과 언어가 상호 침투하며 융합되는 창작의 체험 속에서 문체의 주름으로 발현됨
이 [문체의 주름]이 바로 [시의 형식]
시 : 주제 + 언어(가시적, 주름)
<pre><code> 
문체 文體 style
...
2. 운율(리듬) 시의 음악적 규칙
운 : 자음이나 모음 등 소리의 반복; 두운, 요운, 각운 등
율 : 고저, 장단, 강약 등의 규칙적 반복; 고저율, 강약률, 장단율, 음수율, [음보율] 등
3. 이미지(심상) : 시에서 감각을 자극하는 언어; 시각적, 청각적, 촉각적, 후각적, 미각적, 공감각적 이미지
4. 비유와 상징
비유 : 원관념과 보조관념의 관계로 표현; 은유, 직유, 의인
상징 : 보조관념만으로 원관념을 함축적으로 표현; 원형적, 관습적, 개인적
5. 화자와 어조
화자 : 시에서 말하는 사람; 시적 자아, 서정적 자아, 상상적 자아
어조 : 시에서 말하는 사람의 말투나 태도; 풍자: 기지, 조롱, 야유, 냉소, 아이러니, 패러디 등의 기교
